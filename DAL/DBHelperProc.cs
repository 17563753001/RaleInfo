...
namespace DAL
{
    public class DBHelper
    {
        ...
        public static string connStr = "Data Source=.;Initial Catalog=Excellent_SchoolDB;Integrated Security=True";
        //public static string connStr = ConfigurationManager.ConnectionStrings["school"].ConnectionString;
